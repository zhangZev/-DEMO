 ...
 * 修改内容：
 */
package com.henghao.suyuan.service;
...
import com.henghao.suyuan.model.entity.AppGuideEntity;
...
public class PushParseJsonService extends Service {
	...
	public void downGuideFile(AppGuideEntity appGuideEntity) {
		...
		mBitmapUtils.configDefaultLoadFailedImage(R.drawable.icon_splash);
		mBitmapUtils.configDefaultLoadingImage(R.drawable.icon_splash);
